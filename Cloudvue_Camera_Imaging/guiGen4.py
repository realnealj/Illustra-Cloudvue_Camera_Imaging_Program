...
def run_open_in_chrome_gen4():
    ...
    chrome_opener_gen4.open_in_chrome_gen4(selected_ips)
...
window = tk.Tk()
window.title("Cloudvue Camera Imaging Program GEN4")
...
welcome_message = (
    "Welcome to Cloudvue Camera GEN 4 Imaging Program.\n\n"
...
begin_button = tk.Button(
    ...
    font=("Arial", 8, "bold"),
    command=run_open_in_chrome_gen4,
    bg="#4B4A9C",
    fg="white",
    width=28,
    state=tk.DISABLED,
...
search_label = tk.Label(
    search_frame, text="Search MAC:", font=("Arial", 10), bg="#333333", fg="#DDDDDD"
)
...
search_entry.bind("<KeyRelease>", filter_listbox)  # Trigger filter while typing
...
# Keep track of scanned devices globally for filtering
ip_mac_pairs = []
